          ...
          <div class="row">
            <div style="margin:10px 25px 5px 15px;border-bottom:4px solid #ff000d;">
              <h4 style="margin-left:20px;">教务简报
                ...
                <span style="float:right;font-size:16px;"><a href="__CONTROLLER__/index">教务简报</a></span>
                ...
                <li style="padding:10px 0 10px 35px;;list-style:none;line-height:45px;font-size:16px;">
                    ...
                    <div class="row" style="border-bottom:2px solid #e1e1e1;">
                      <div style="display:inline;">
                        <a href="__CONTROLLER__/column/id/{$vo.id}"><img style="width:25px;height:25px;margin-right:20px;" src="__PUBLIC__/img/bookmark.png">{$vo.title}</a>
                      </div>

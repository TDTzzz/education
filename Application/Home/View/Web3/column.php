      ...
      <div class="row" style="margin-top:40px;">
        <div class="col-md-3">
          <ul id="commonleft">
            ...
            <li><img src="__PUBLIC__/img/common.png"><a href="<?php echo U('Web3/column?type=教学管理与信息办公室');?>">教学管理与信息办公室</a></li>
            <li><img src="__PUBLIC__/img/common.png"><a href="<?php echo U('Web3/column?type=教改与质量办公室');?>">教改与质量办公室</a></li>
            <li><img src="__PUBLIC__/img/common.png"><a href="<?php echo U('Web3/column?type=学籍管理办公室');?>">学籍管理办公室</a></li>
            <li><img src="__PUBLIC__/img/common.png"><a href="<?php echo U('Web3/column?type=实践教学办公室');?>">实践教学办公室</a></li>
          </ul>
        </div>
        <div class="col-md-9">
          <div class="row">
            <div style="margin:10px 25px 5px 15px;border-bottom:4px solid #ff000d;">
              <h4 style="margin-left:20px;">{$type}
                ...
                <span style="float:right;font-size:16px;"><a href="__CONTROLLER__/index">办事指南/</a></span>

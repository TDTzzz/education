          ...
          <div class="page-content">
            <div class="pagebreadcrumbs">
              <ul class="breadcrumb">
                ...
                <li><a href="/index.php/Admin/Webhome/index">教务通知</a></li>
            ...
            <div class="page-body">
                ...
                <div class="row">
                  <div class="col-lg-12 col-sm-12 col-xs-12">
                    ...
                    <input type="submit" value="添加商品" style="width:200px;margin-top:20px;margin-left:160px;" class="btn btn-darkorange btn-block">
                  </form>

...
<html>
  <head>
    ...
    <!--引入富文本编辑器-->
    <script src="/education/Public/ueditor/ueditor.config.js"></script>
    <script src="/education/Public/ueditor/ueditor.all.min.js"></script>
    <script src="/education/Public/ueditor/lang/zh-cn/zh-cn.js"></script>
  </head>
  <body>
    ﻿<div class="navbar">
          ...
          <div class="page-content">
            <div class="pagebreadcrumbs">
              <ul class="breadcrumb">
                ...
                <li><a href="/education/index.php/Admin/Webhome/column1">网站首页</a></li>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <select name="department">
                            <option value="外语学部">外语学部</option>
                            <option value="城市建设工程学部">城市建设工程学部</option>
                            <option value="经济管理学部">经济管理学部</option>
                            <option value="机械与电气工程学部">机械与电气工程学部</option>
                            <option value="人文社会科学学部">人文社会科学学部</option>
                            <option value="信息科学与技术学部">信息科学与技术学部</option>
                            <option value="基础学部">基础学部</option>
                            <option value="继续教育学部">继续教育学部</option>

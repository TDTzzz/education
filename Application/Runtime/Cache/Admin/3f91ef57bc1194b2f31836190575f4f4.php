        ...
        <!-- /Sidebar Menu -->
          ...
          <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo U("/Admin/Web6/add");?>'">
                          ...
                          <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                              <?php if(is_array($articles)): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$article): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td align="center">
                                  <a href="/index.php/Admin/Web6/edit/id/<?php echo ($article["id"]); ?>" class="btn btn-primary btn-sm shiny">
                                      <i class="fa fa-edit"></i> 编辑
                                  </a>
                                  <a href="#" onClick="warning('确实要删除吗', '/index.php/Admin/Web6/del/id/<?php echo ($article["id"]); ?>')" class="btn btn-danger btn-sm shiny">

                      ...
                      <div class="widget-body">
                        <div class="flip-scroll">
                          <table class="table table-bordered table-hover">
                            ...
                            <?php if(is_array($users)): $i = 0; $__LIST__ = $users;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?><tbody>
                              <tr>
                                <td align="center"><?php echo ($user["id"]); ?></td>
                                <td align="center"><?php echo ($user["name"]); ?></td>
                                <td align="center">
                                  <a href="/index.php/Admin/Admin/edit/id/<?php echo ($user["id"]); ?>" class="btn btn-primary btn-sm shiny">
                                      <i class="fa fa-edit"></i> 编辑
                                  </a>
                                  <a href="#" onClick="warning('确实要删除吗', '/index.php/Admin/Admin/del/id/<?php echo ($user["id"]); ?>')" class="btn btn-danger btn-sm shiny">

    ...
    <div class="main-container container-fluid">
      <div class="page-container">
        ...
        <ul class="nav sidebar-menu">
            ...
            <li>
                <a href="/index.php/Admin/Webhome/Web5/index" class="menu-dropdown">
                    <i class="menu-icon fa fa-gear"></i>
            ...
            <li>
                <a href="/index.php/Admin/Webhome/Web6/index" class="menu-dropdown">
                    <i class="menu-icon fa fa-gear"></i>
            ...
            <li>
                <a href="/index.php/Admin/Webhome/Web7/index" class="menu-dropdown">
                    <i class="menu-icon fa fa-gear"></i>
            ...
            <li>
                <a href="/index.php/Admin/Webhome/Web8/index" class="menu-dropdown">
                    <i class="menu-icon fa fa-gear"></i>
          ...
          <div class="page-content">
            <div class="pagebreadcrumbs">
              <ul class="breadcrumb">
                ...
                <li>网站首页</li>
                <li class="active">教务通知</li>
              </ul>
            </div>
            <div class="page-body">


                <button type="button" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo U("/Admin/Webhome/column2add");?>'">
                          ...
                          <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                              <?php if(is_array($articles)): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$article): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td align="center">
                                  <a href="/index.php/Admin/Webhome/column2edit/id/<?php echo ($article["id"]); ?>" class="btn btn-primary btn-sm shiny">
                                      <i class="fa fa-edit"></i> 编辑
                                  </a>
                                  <a href="#" onClick="warning('确实要删除吗', '/index.php/Admin/Webhome/column2del/id/<?php echo ($article["id"]); ?>')" class="btn btn-danger btn-sm shiny">

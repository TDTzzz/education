  ...
  <div class="row">
    <div class="col-md-12" style="padding:0;">
      ...
      <div class="row" style="margin-top:40px;">
        <div class="col-md-3">
          <ul id="commonleft">
            <li class="commonleft-top">下载中心</li>
            <li><img src="/Public/img/common.png"><a href="<?php echo U('Web7/column?type=教学管理与信息办公室');?>">教学管理与信息办公室</a></li>
            <li><img src="/Public/img/common.png"><a href="<?php echo U('Web7/column?type=学籍管理办公室');?>">学籍管理办公室</a></li>
            <li><img src="/Public/img/common.png"><a href="<?php echo U('Web7/column?type=教学改革与质量办公室');?>">教学改革与质量办公室</a></li>
            <li><img src="/Public/img/common.png"><a href="<?php echo U('Web7/column?type=实践教学办公室');?>">实践教学办公室</a></li>
          </ul>
        </div>
        <div class="col-md-9">
          <div class="row">
            <div style="margin:10px 25px 5px 15px;border-bottom:4px solid #ff000d;">
              <h4 style="margin-left:20px;"><?php echo ($type); ?>
                ...
                <span style="float:right;font-size:16px;"><a href="/index.php/Home/Web7/index">下载中心/</a></span>
              ...
              <?php if(is_array($articles)): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li style="padding:10px 0 10px 35px;;list-style:none;line-height:45px;font-size:16px;">
                    ...
                    <div class="row" style="border-bottom:2px solid #e1e1e1;">
                      <div style="display:inline;">
                        <a href="/index.php/Home/Web7/columnindex/id/<?php echo ($vo["id"]); ?>"><img style="width:25px;height:25px;margin-right:20px;" src="/Public/img/bookmark.png"><?php echo ($vo["title"]); ?></a>
                      </div>

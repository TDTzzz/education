  ...
  <div class="row">
    <div class="col-md-12" style="padding:0;">
      ...
      <div class="row" style="margin-top:40px;">
        <div class="col-md-3">
          <ul id="commonleft">
            <li class="commonleft-top">教务简报</li>
            <li><img src="/Public/img/common.png"><a href="/index.php/Home/Web2/index">机构设置</a></li>
            <li><img src="/Public/img/common.png"><a href="/index.php/Home/Web3/index">办事指南</a></li>
            <li><img src="/Public/img/common.png"><a href="/index.php/Home/Web4/index">规章制度</a></li>
            <li><img src="/Public/img/common.png"><a href="/index.php/Home/Web5/index">教务简报</a></li>
            <li><img src="/Public/img/common.png"><a href="/index.php/Home/Web6/index">专升本</a></li>
            <li><img src="/Public/img/common.png"><a href="/index.php/Home/Web7/index">下载中心</a></li>
            <li><img src="/Public/img/common.png"><a href="/index.php/Home/Web8/index">联系我们</a></li>
          </ul>
        </div>
        <div class="col-md-9">
          <div class="row">
            <div style="margin:10px 25px 5px 15px;border-bottom:4px solid #ff000d;">
              <h4 style="margin-left:20px;">教务简报

                <span style="float:right;font-size:16px;"><a href="/index.php/Home/Web5/index">教务简报</a></span>
              ...
              <?php if(is_array($articles)): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li style="padding:10px 0 10px 35px;;list-style:none;line-height:45px;font-size:16px;">
                    ...
                    <div class="row" style="border-bottom:2px solid #e1e1e1;">
                      <div style="display:inline;">
                        <a href="/index.php/Home/Web5/column/id/<?php echo ($vo["id"]); ?>"><img style="width:25px;height:25px;margin-right:20px;" src="/Public/img/bookmark.png"><?php echo ($vo["title"]); ?></a>
                      </div>

...
<!-- Controls -->
      ...
      <div class="row" style="margin-top:40px;">
        <div class="col-md-3">
          <ul id="indexleft">
            <li style="background-color:white;">教务通知</li>
            <li><a href="#">机构设置</a></li>
            <li><a href="#">办事指南</a></li>
            <li><a href="#">规章制度</a></li>
            <li><a href="#">教务简报</a></li>
          ...
          <div class="row" style="border-top: 5px solid #b70c0c;margin-right:50px;">
            <div style="padding:5px 5px 5px 15px;font-size:18px;color:#E53C3C;border-bottom:1px solid #e1e1e1;">
              ...
              <div class="more" style="float:right;">
                <a href=__CONTORLLER__/index>首页</a>
                <a href="/index.php/Home/Index/column2">专业特色</a>
              </div>
            </div>
            <ul style="padding-left:0px;">
              <?php if(is_array($articles)): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li style="padding-left:55px;list-style:none;height:60px;line-height:60px;font-size:16px;border-bottom:1px solid #e1e1e1;">
                  <a href="/index.php/Home/Index/column2index/id/<?php echo ($vo["id"]); ?>"><i class="fa fa-rub"></i><?php echo ($vo['title']); ?></a>
                  <span style="float:right;"><?php echo date("Y-m-d",$vo['time']);?></span></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
          </div>

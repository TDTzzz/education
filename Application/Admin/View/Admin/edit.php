                    ...
                    <div class="widget">
                      ...
                      <div class="widget-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" value="<?php echo $user['name'];?>" name="name" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" value="<?php echo $user['password'];?>" name="password" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="col-sm-3">
                            <div class="widget-buttons buttons-bordered">
                              <label>
                                <input
                                <if condition="$user['is_important'] eq 1">checked</if>
                                 type="checkbox" name="is_important" class="checkbox-slider colored-darkorange">
